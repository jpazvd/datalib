...
{pstd}
The buckets come from the archive rather than from taste -- across the 55,703 files in the
...
{phang2}{cmd:. datalib_explorer , root(Z:/_staging_datalib-nut) path(Afghanistan) files sizes}{p_end}

{pstd}Folder names containing spaces need no special handling:{p_end}
{phang2}{cmd:. datalib_explorer , root(Z:/_staging_datalib-nut) path(Afghanistan/2010 SDHS)}{p_end}

{pstd}The same thing from the legacy option surface, where {opt library()} supplies the
root:{p_end}
{phang2}{cmd:. datalib , explorer library(Z:/_staging_datalib-nut) path(Afghanistan)}{p_end}
...
{phang2}{cmd:. datalib_explorer , root(Z:/_staging_datalib-nut)}{p_end}
{phang2}{cmd:. local top `"`r(dirs)'"'}{p_end}
{phang2}{cmd:. foreach d of local top {c -(}}{p_end}
{phang2}{cmd:.     datalib_explorer , root(Z:/_staging_datalib-nut) path(`"`d'"')}{p_end}
...
contain spaces -- 41 of the 193 top-level folders in one staging tree do -- and an
