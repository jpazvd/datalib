...
*! Version: 1.12.0      Date: <2026-08-13>
...
program define datalib_resolve, rclass
    ...
    quietly {
        ...
        * (config/grammar.md section 6); this makes that deliberate. The rc is
        * the same either way -- `: dir` on a missing directory raises 601 on
        * its own, measured -- so what this buys is the MESSAGE: which path was
        * looked for, and that it was the library root rather than some file.
