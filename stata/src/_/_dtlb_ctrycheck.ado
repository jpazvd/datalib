...
capture program drop _dtlb_ctrycheck
program define _dtlb_ctrycheck, rclass
...
/*******************************************************
 ...
 _dtlb_ctrycheck , path("D:\datalib\")
 return list

 _dtlb_ctrycheck , path("D:\datalib\BRA\")
 return list
 
 _dtlb_ctrycheck , path("D:\datalib\BRA\BRA_2012_PNADC")
 return list
*******************************************************/
